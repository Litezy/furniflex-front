...
const HeroSection = ({ heroRef }) => {
    ...
    return (
        ...
        <div className="w-full overflow-hidden">
            ...
            <div className="mt-24 lg:pl-10 px-4 lg:px-0 w-full hero-section" ref={heroRef}>
                <div className="flex items-center gap-10 w-full flex-col lg:flex-row">
                    ...
                    <div className="lg:w-1/2 overflow-auto md:overflow-hidden">
                        ...
                        <div className="flex  items-center justify-between lg:w-2/3">
                            <div className="flex flex-col items-start ">
                                <div className="flex items-center">
                                    <Counter end={2500} duration={2000} />+
                                </div>
